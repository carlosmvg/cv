...
sap.ui.require.preload({
	"sap/ushell_abap/workbenchTransport/Component.js":function(){//Copyright (c) 2009-2020 SAP SE, All Rights Reserved
...
sap.ui.define([
    ...
    return UIComponent.extend("sap.ushell_abap.workbenchTransport.Component", {
        ...
        setIconTabBar: function () {
            // dummy function for compatibility
        },

        setShowAssignButton: function () {
            // dummy function for compatibility
        }
    });
});
},
	"sap/ushell_abap/workbenchTransport/controller/TransportInformation.controller.js":function(){// Copyright (c) 2009-2020 SAP SE, All Rights Reserved
...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell_abap.workbenchTransport.controller.TransportInformation", {
        onInit: function () {
...
sap.ui.define([
    ...
    TransportHelper.prototype._readTransportInformation = function (sPageId) {
        var sUrl = "/transportSet",
            filter = new Filter("pageId", FilterOperator.EQ, sPageId);
    ...
    TransportHelper.prototype._showTransport = function (oPage) {
        var sPackageName = oPage.devclass;

        if (oPage && sPackageName && !oPage.transportId) {
    ...
    TransportHelper.prototype.checkShowLocked = function (page) {
        return this._getTransportLockedInformation(page.id).then(function (transportLockedInformation) {
