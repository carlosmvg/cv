...
sap.ui.define([
    ...
    // used for space/page functionality to load allcatalogs
    var sFAKE_PAGE_ID = "/UI2/FakePageId";
        ...
        this.getCatalogs = function () {
            ...
            function startLoading (bSynchronous) {
                if (oTargetMappingServiceConfig && oTargetMappingServiceConfig.cacheId) {
                    ...
                    if (Config.last("/core/spaces/enabled")) {
                        oCacheTokens.put(sFAKE_PAGE_ID, oTargetMappingServiceConfig.cacheId);
                    }
                }
        ...
        this._oCatalogTileIndexPromise = sap.ushell.Container.getServiceAsync("PageBuilding")
            .then(function (oPageBuildingService) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    oUI2PageBuildingService.readAllCatalogs("/UI2/FakePageId", resolve, reject,
