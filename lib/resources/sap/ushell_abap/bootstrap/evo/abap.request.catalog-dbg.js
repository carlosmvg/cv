...
function (oAbapUtils) {
     ...
     * @param {string} [sPageId] Page id for allCatalogs request. Default value is "/UI2/Fiori2LaunchpadHome"
     *
     ...
     * @param {string} [sPageId] Page id for allCatalogs request.
     *
     * @private
     * @since 1.70.0
     */
    function requestAllCatalogs (oStartupResult, bNoOData, sPageId) {
        if (bNoOData) {
            return;
        }

        var sAllCatalogServiceUrl = _getAllCatalogsUrl(oStartupResult, "pbFioriHome", sPageId),
