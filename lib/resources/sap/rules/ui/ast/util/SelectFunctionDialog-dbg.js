sap.ui.define([
    ...
    SelectFunctionDialog.prototype._getAttributeAstExpressionBasic = function (bindingContext, sAriaValue) {
        var that = this;
    ...
    SelectFunctionDialog.prototype._tableColumnsFactory = function (sId, oContext) {
        ...
        var itemTemplate = new sap.m.ColumnListItem({
            cells: [that._getAttributeAstExpressionBasic("selectAttributeLabelId"),
                new sap.m.Select({
    ...
    SelectFunctionDialog.prototype._createSelectFunctionDialog = function (data, callBack, AstExpressionLanguage, dialogOpenedCallbackReference, jsonData) {
        ...
        var functionSelect = that._createFunctionSelectionDropDown(data,"selectFunctionSelectionLabelId");
        ...
        var oWhereControl = that._createWhereAstExpressionBasic("selectWhereLabelId");
        ...
        var verticalLayoutForSelectFunction = new sap.ui.layout.form.SimpleForm({
            ...
            editable: true,
            content: [
                new sap.m.Label("selectFunctionSelectionLabelId",{
                ...
                new sap.m.Label("selectAttributeLabelId",{
                ...
                attributeTable,
                new sap.m.Label("selectWhereLabelId",{
