 ...
 */
sap.ui.predefine('sap/zen/dsh/library',["sap/ui/core/Core","sap/ui/core/library","sap/ui/layout/library","sap/ui/table/library","sap/m/library","sap/zen/commons/library","sap/zen/crosstab/library"],function(){sap.ui.getCore().initLibrary({name:"sap.zen.dsh",dependencies:["sap.ui.core","sap.ui.table","sap.ui.layout","sap.m","sap.zen.commons","sap.zen.crosstab"],types:[],interfaces:[],controls:["sap.zen.dsh.AnalyticGrid","sap.zen.dsh.Dsh"],elements:[],noLibraryCSS:true,version:"1.82.1"});return sap.zen.dsh;});
sap.ui.require.preload({
	"sap/zen/dsh/manifest.json":'{"_version":"1.21.0","sap.app":{"id":"sap.zen.dsh","type":"library","embeds":["fioriwrapper"],"applicationVersion":{"version":"1.82.1"},"title":"Design Studio Runtime Library.","description":"Design Studio Runtime Library.  Intended only to be used within S/4 HANA Fiori applications.","ach":"BI-RA-AD-EA","resources":"resources.json","offline":true,"openSourceComponents":[{"name":"underscore","packagedWithMySelf":true,"version":"0.0.0"},{"name":"xlsx","packagedWithMySelf":true,"version":"0.0.0"},{"name":"jszip","packagedWithMySelf":true,"version":"0.0.0"}]},"sap.ui":{"technology":"UI5","supportedThemes":[]},"sap.ui5":{"dependencies":{"minUI5Version":"1.82","libs":{"sap.ui.core":{"minVersion":"1.82.0"},"sap.ui.table":{"minVersion":"1.82.0"},"sap.ui.layout":{"minVersion":"1.82.0"},"sap.m":{"minVersion":"1.82.0"},"sap.viz":{"minVersion":"1.82.0","lazy":true},"sap.zen.commons":{"minVersion":"1.82.1"},"sap.zen.crosstab":{"minVersion":"1.82.1"}}},"library":{"i18n":false,"css":false,"content":{"controls":["sap.zen.dsh.AnalyticGrid","sap.zen.dsh.Dsh"],"elements":[],"types":[],"interfaces":[]}}}}'
