 ...
 */
sap.ui.predefine('sap/zen/crosstab/library',["sap/ui/core/Core","sap/ui/core/library"],function(){sap.ui.getCore().initLibrary({name:"sap.zen.crosstab",dependencies:["sap.ui.core"],types:[],interfaces:[],controls:["sap.zen.crosstab.Crosstab","sap.zen.crosstab.DataCell","sap.zen.crosstab.HeaderCell"],elements:[],version:"1.82.1"});return sap.zen.crosstab;});
sap.ui.require.preload({
	"sap/zen/crosstab/manifest.json":'{"_version":"1.21.0","sap.app":{"id":"sap.zen.crosstab","type":"library","embeds":[],"applicationVersion":{"version":"1.82.1"},"title":"Design Studio Crosstab library.","description":"Design Studio Crosstab library.  NOT INTENDED FOR STANDALONE USAGE.","ach":"BI-RA-AD-EA","resources":"resources.json","offline":true},"sap.ui":{"technology":"UI5","supportedThemes":["base","sap_belize","sap_belize_hcb","sap_belize_hcw","sap_belize_plus","sap_bluecrystal","sap_fiori_3","sap_fiori_3_dark","sap_fiori_3_hcb","sap_fiori_3_hcw","sap_hcb"]},"sap.ui5":{"dependencies":{"minUI5Version":"1.82","libs":{"sap.ui.core":{"minVersion":"1.82.0"}}},"library":{"i18n":false,"content":{"controls":["sap.zen.crosstab.Crosstab","sap.zen.crosstab.DataCell","sap.zen.crosstab.HeaderCell"],"elements":[],"types":[],"interfaces":[]}}}}'
