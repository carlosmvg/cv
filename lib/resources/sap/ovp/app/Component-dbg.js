sap.ui.define(["sap/ui/core/UIComponent", "sap/ovp/cards/rta/SettingsDialogConstants",
    ...
    "sap/ui/model/resource/ResourceModel", "sap/ovp/app/resources", "sap/ui/core/CustomData", "sap/ushell/Config", "sap/base/util/merge", "sap/base/util/isEmptyObject", "sap/ovp/cards/ovpLogger", "sap/ui/rta/RuntimeAuthoring" /*Don't Remove this. Important for Personalization to work*/],

    function (UIComponent, SettingsDialogConstants, Router, ObjectPath,
              JSONModel, DashboardLayoutUtil, ViewType, ResourceModel, OvpResources, CustomData, Config, merge, isEmptyObject, ovpLogger) {
        "use strict";
        ...
        var Log = new ovpLogger("OVP.app.Component");
        return UIComponent.extend("sap.ovp.app.Component", {
            ...
            createXMLView: function (ovpConfig) {
                ...
                if (ovpConfig.globalFilterEntityType) {
                    var oEntityType = oFilterMetaModel.getODataEntityType(ovpConfig.globalFilterEntityType),
                 ...
                 * temp
                 */
                var oView = new sap.ui.core.mvc.XMLView("mainView", {
                    height: "100%",
                    preprocessors: {
                        xml: {
                            bindingContexts: {
