sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/library", "sap/ui/model/odata/ODataUtils", "sap/ovp/cards/generic/Component", "sap/ovp/cards/v4/generic/Component",
    ...
    "sap/base/security/encodeURL", "sap/base/util/ObjectPath", "sap/ui/thirdparty/jquery", "sap/base/util/merge","sap/ui/fl/apply/api/FlexRuntimeInfoAPI","sap/ui/core/CustomData", "sap/ovp/cards/ovpLogger", "sap/base/util/isEmptyObject"],
    ...
    function (Controller, SapMLibrary, ODataUtils, Component, ComponentV4, NavigationHandler, MessageBox, CommonUtils, PersonalizationUtils,
        ...
        TemplateBaseExtension, ControllerExtension, OVPUtils, encodeURL, ObjectPath, jQuery, merge, FlexRuntimeInfoAPI, CustomData, ovpLogger, isEmptyObject) {
        ...
        var Log = new ovpLogger("OVP.app.Main");
        return Controller.extend("sap.ovp.app.Main", {
            ...
            recreateCard: function (sCardProperties) {
                ...
                if (sCardProperties.customParams) {
                    oCard.settings.customParams = sCardProperties.customParams;
                }
            ...
            _checkForAuthorization: function (cardsIntentWithIndex, cardsIntent) {
                ...
                if (oNavigationHandler && oNavigationHandler.oCrossAppNavService) {
                    oNavigationHandler.oCrossAppNavService.isIntentSupported(cardsIntent).done(function (oResponse) {
                        ...
                        var uiCardsModel = this.getView().getModel('ui').getProperty('/cards');
                        ...
                        for (var k = 0; k < unsupportedCards.length; k++) {
                            for (var l = 0; l < aOrderedCards.length; l++) {
                                if (aOrderedCards[l].id == unsupportedCards[k]) {
                                    ...
                                    uiCardsModel.map(removeUnsupportedCards, {unsupportedCardIndex: k});
                        ...
                        this.getView().getModel('ui').setProperty('/cards', uiCardsModel);
                        this.getView().getModel("ui").setProperty('/aOrderedCards', aOrderedCards);
            ...
            _initFlexibilityPersonalization: function () {
                ...
                if (sLayout === "sap.ovp.ui.DashboardLayout") {
                    flexibilityPath = "sap/ovp/flexibility/DashboardLayout.flexibility";
                } else {
                    flexibilityPath = "sap/ovp/flexibility/EasyScanLayout.flexibility";
                }
                for (var i = 0; i < aOrderedCards.length; i++) {
