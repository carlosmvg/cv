sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
    ...
    "sap/ovp/app/OVPUtils", "sap/ui/events/KeyCodes", "sap/base/util/isPlainObject", "sap/base/util/merge", "sap/ovp/cards/ovpLogger", "sap/ovp/cards/jUtils", "sap/base/util/isEmptyObject"],
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, GenericAppLibrary, jQuery, OvpResources, OVPUtils, KeyCodes, isPlainObject, merge, ovpLogger, jUtils, isEmptyObject) {
        "use strict";
        var Log = new ovpLogger("OVP.generic.Card");
        return Controller.extend("sap.ovp.cards.v4.generic.Card", {
            ...
            getEntitySet: function () {
                if (!this.entitySet) {
                    ...
                    this.entitySet = this.getMetaModel().getObject("/Books");
                }
