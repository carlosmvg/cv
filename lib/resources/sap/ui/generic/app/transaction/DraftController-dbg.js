...
sap.ui.define(["sap/ui/thirdparty/jquery", "./BaseController", "./DraftContext", "sap/base/Log", "sap/ui/model/Context"], function(jQuery, BaseController, DraftContext, Log, Context) {
	"use strict";
	 ...
	 * @public
	 */
	DraftController.prototype.createNewDraftEntity = function(sEntitySet, sPath, vPredefinedValues, bCanonicalRequest, sRootExpand) {
		var that = this;
		...
		// Only NewAction FunctionImport without mandatory parameter is called , if mandatory parameter exists then fall back to the createDraft
		var bUseNewAction = oFunctionImport && !(oFunctionImport.parameter && oFunctionImport.parameter.some(function(oParameterDef) {
			return oParameterDef.mode && oParameterDef.mode.toUpperCase() === "IN";
		}));
		var oPromise0 = bUseNewAction ? this._callAction(sFunctionImport, oContext, mParameters1) : this.createDraft(sEntitySet, sPath, mParameters1);
