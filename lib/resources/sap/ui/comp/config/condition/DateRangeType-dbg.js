		...
		if (!oJson.conditionTypeInfo) {
			if (oJson.ranges && oJson.ranges.length == 1) {
				...
				if (this.hasSemanticDate(oJson)) {
					...
					oSemanticValue1 = oJson.ranges[0].semantic.value1 ? oJson.ranges[0].semantic.value1 : oSemanticValue1;
					oSemanticValue2 = oJson.ranges[0].semantic.value2 ? oJson.ranges[0].semantic.value2 : oSemanticValue2;
				} else {
				...
				oJson.conditionTypeInfo = {
					...
					data: {
						...
						value1: oSemanticValue1 ? oSemanticValue1 : oJson.ranges[0].value1,
						value2: oSemanticValue2 ? oSemanticValue2 : oJson.ranges[0].value2,
