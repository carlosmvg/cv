...
sap.ui.define([
	...
	function(jQuery, library, Core, ExportDialog, EventProvider, Device, SpreadsheetExport, Log, ExportUtils) {
		 ...
		 *          <li><code>version</code> (string) - Application version that creates the XLSX document (default: "1.82.2")</li>
		...
		var getCountFromBinding = function(oBinding) {
			...
			} else if (typeof oBinding.isLengthFinal === 'function' && oBinding.isLengthFinal()) {
