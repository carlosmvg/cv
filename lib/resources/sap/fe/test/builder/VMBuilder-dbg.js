						...
						FEBuilder.create(this)
							...
							.doOnChildren(
								FEBuilder.create(this)
									...
									.doConditional(FEBuilder.Matchers.bool(bSetAsDefault), OpaBuilder.Actions.press())
							)
							.doOnChildren(
								FEBuilder.create(this)
									.hasId(/-execute$/)
									.hasType("sap.m.CheckBox")
									.doConditional(FEBuilder.Matchers.bool(bApplyAutomatically), OpaBuilder.Actions.press())
							)
							.doOnChildren(
								FEBuilder.create(this)
									.hasId(/-variantsave$/)
