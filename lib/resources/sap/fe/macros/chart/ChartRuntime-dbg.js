		...
		var ChartRuntime = {
			...
			fnUpdateChart: function(oEvent) {
				...
				if (sSelectedContextModelName) {
					...
					if (!oContextModel.getProperty("/$contexts")) {
						oContextModel.setProperty("/$contexts", {});
					}
					if (!oContextModel.getProperty(sContextCollectionName)) {
					...
					oContextModel.setProperty(sContextCollectionName + "/selectedContexts", aSelectedContexts);
					oContextModel.setProperty(
						sContextCollectionName + "/numberOfSelectedContexts",
						oInnerChart.getSelectedDataPoints().count
					);
