...
var testSVG = function testSVG(document) {
    ...
    // IE does not wait till the Image is loaded from the src before adding it to the Canvas causing the drawImage() to fail with runtime error "UnspecifiedError" and execution to always go to the catch block and return false.
	// Original lines:
	// var img = new Image();
    // var canvas = document.createElement('canvas');
    // var ctx = canvas.getContext('2d');
