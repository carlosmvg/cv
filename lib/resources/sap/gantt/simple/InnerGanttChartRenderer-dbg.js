...
sap.ui.define([
	...
	InnerGanttChartRenderer.renderRowBackgrounds = function(oRm, oGantt, aRowStates) {
		...
		oRm.writeAttribute("id", oGantt.getId() + "-rowBackgrounds");
		oRm.write(">");

		aRowStates.forEach(function(oRowState, iIndex){
			oRm.write("<rect");
			oRm.writeAttribute("id", oGantt.getId() + "-bgRow-" + iIndex);
	...
	InnerGanttChartRenderer.renderRowBorders = function(oRm, oGantt, aRowStates) {
		...
		oRm.writeAttribute("id", oGantt.getId() + "-rowBorders");
		oRm.write(">");
		...
		aRowStates.forEach(function(oRowState, iIndex) {
			...
			oRm.write("<line");
			oRm.writeAttribute("id", oGantt.getId() + "-bgRowBorder-" + iIndex);
