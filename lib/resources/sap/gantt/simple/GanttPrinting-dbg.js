...
sap.ui.define([
	...
	function (
		...
		GanttPrinting.prototype._updateGanttCanvas = function () {
			...
			// set visible horizon first because (visibleHorizon <= totalHorizon)
		...
		GanttPrinting.prototype._drawClonedGantt = function () {
			...
			if (this._ganttChartClone.getTable().getBindingInfo("rows").binding == null) {
				this._ganttChartClone.oPropagatedProperties = this._getOriginalGanttChart()._getPropertiesToPropagate();
				this._ganttChartClone.propagateProperties(true);
			}
