...
sap.ui.define([
	...
	var GanttSyncedControl = Control.extend("sap.gantt.simple.GanttSyncedControl", /** @lends sap.gantt.simple.GanttSyncedControl.prototype */ {
		...
		renderer: function(oRm, oControl) {
			...
			oRm.writeAttribute("id", oGantt.getId() + "-ganttBGFlexContainer");
			oRm.write(">");
			oRm.write("<div class='sapGanttBackgroundContainer sapGanttBackgroundScrollbar'");
			oRm.writeAttribute("id", oGantt.getId() + "-ganttBGContainerWithScrollBar");
			oRm.write(">");

			// Table container
			oRm.write("<div");
			oRm.addClass("sapGanttBackgroundTable");
			oRm.writeAttribute("id", oGantt.getId() + "-ganttSyncedControlTable");
			oRm.writeClasses();
			oRm.write(">");
	...
	GanttSyncedControl.prototype.renderGanttHeaderPlaceholder = function(oRm, oGantt) {
		// Gantt Chart Header
		oRm.write("<div style='height:" + (this.state.layout.top + this.state.layout.headerHeight) + "px'");
		oRm.writeAttribute("id", oGantt.getId() + "-ganttHeader");
	...
	GanttSyncedControl.prototype.renderGanttBodyPlaceholder = function(oRm, oGantt) {
		...
		oRm.writeAttribute("id", oGantt.getId() + "-sapGanttBackgroundTableContent");
		oRm.write(">");
		oRm.write("<div");
	...
	GanttSyncedControl.prototype.renderVerticalScrollbarContainer = function(oRm, oControl, oGantt) {
		...
		oRm.writeAttribute("id", oGantt.getId() + "-sapGanttVerticalScrollBarContainer");
		oRm.write(">");
	...
	GanttSyncedControl.prototype.renderHorizontalScrollbarContainer = function(oRm, oGantt) {
		...
		oRm.writeAttribute("id", oGantt.getId() + "-horizontalScrollContainer");
		oRm.write(">");
		oRm.write("</div>");
	};
