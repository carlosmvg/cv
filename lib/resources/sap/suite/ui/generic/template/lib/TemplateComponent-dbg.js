sap.ui.define(["sap/ui/core/CustomizingConfiguration",
	...
	"sap/suite/ui/generic/template/lib/FeError"
		...
		function createParameterModel(sEntityType, oComponentRegistryEntry, oMetaModel, fnTemplateSpecificParameters) {
			...
			var oSettings = extend({}, oComponentRegistryEntry.routeConfig.component.settings);
			...
			return new JSONModel({
				...
				templateSpecific: fnTemplateSpecificParameters && fnTemplateSpecificParameters(oMetaModel, oSettings, Device, sEntitySet),
		...
		function createXMLView(oComponentRegistryEntry, aCacheKeys) {
			var oComponent = oComponentRegistryEntry.oComponent,
				...
				oModel = oComponent.getAppComponent().getModel(),
		...
		function fnCreateEmbeddedComponents(oComponentRegistryEntry){
			...
			oComponentRegistryEntry.oTemplateContract.oBusyHelper.setBusy(oComponentRegistryEntry.reuseComponentsReady);
		}
