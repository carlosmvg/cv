...
], function(BaseObject, Filter, MultipleTablesModeHelper, SingleTableModeHelper, SelectionVariant, MetadataAnalyser, FeLogger, testableHelper, extend, encodeURL, DateTimeUtil, isEmptyObject) {
	"use strict";
