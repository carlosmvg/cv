...
sap.ui.define(["sap/ui/core/mvc/ControllerExtension",
		...
		"sap/base/util/deepExtend"
			...
			ComponentUtils, CommonEventHandlers, testableHelper, CommonMethods, FeLogger, deepExtend) {
			"use strict";
			...
			return {
				...
				getTemplateComponent: function(getMethods, sComponentName, oComponentDefinition) {
					...
					oComponentDefinition.setIsRefreshRequired = function(bIsRefreshRequired) {
						...
						var oComponentRegistryEntry = getComponentRegistryEntry(this);
						// Refresh needs to be triggered if bIsRefreshRequired is tue and we are not currently navigating (in that case the refresh would be trigered by onActivate later anyway)
