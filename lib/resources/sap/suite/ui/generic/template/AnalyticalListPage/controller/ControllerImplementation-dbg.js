...
sap.ui.define(["sap/ui/generic/app/navigation/service/SelectionVariant",
	...
	"sap/suite/ui/generic/template/listTemplates/semanticDateRangeTypeHelper"
			...
			OverflowToolbar, ToolbarSpacer, SapMLibrary, Context, ALPHelper, FeLogger, FilterUtil, ObjectPath, ShareUtils, merge, deepExtend,
			SemanticDateRangeHelper) {
		"use strict";
		...
		return {
			getMethods: function(oViewProxy, oTemplateUtils, oController) {
				...
				function onSmartFilterBarInitialized(){
					//to show old filter dialog BCP-2080352127
					oState.oSmartFilterbar.setShowOldFilterDialog();
