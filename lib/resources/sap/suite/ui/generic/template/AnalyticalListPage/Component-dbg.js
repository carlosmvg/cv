sap.ui.define(["sap/ui/core/mvc/OverrideExecution","sap/suite/ui/generic/template/lib/TemplateAssembler",
	...
	"sap/suite/ui/generic/template/js/preparationHelper", "sap/base/util/deepExtend", "sap/suite/ui/generic/template/listTemplates/semanticDateRangeTypeHelper"
], function(OverrideExecution, TemplateAssembler, ControllerImplementation, JSONModel, controllerFrameworkExtensions, preparationHelper, deepExtend, semanticDateRangeTypeHelper) {
	"use strict";
	...
	function getMethods(oComponent,oComponentUtils) {
		...
		return {
			...
			getTemplateSpecificParameters: function(oMetaModel, oSettings, Device, sLeadingEntitySet){
				...
				oAlpSettings.isAnalyticalListPage = true;
				oAlpSettings.allControlConfiguration = oEntityType["com.sap.vocabularies.UI.v1.SelectionFields"] ? oEntityType["com.sap.vocabularies.UI.v1.SelectionFields"].slice() : [];
				oAlpSettings.datePropertiesSettings = semanticDateRangeTypeHelper.setSemanticDateRangeSettingsForDateProperties(oAlpSettings, oEntityType);
