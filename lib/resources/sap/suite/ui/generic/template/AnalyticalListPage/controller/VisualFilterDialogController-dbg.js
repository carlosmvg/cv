sap.ui.define([
	    ...
	    "sap/ui/model/FilterOperator", "sap/m/DatePicker", "sap/suite/ui/generic/template/lib/FeLogger",
	...
	var vfdController = Controller.extend("sap.suite.ui.generic.template.AnalyticalListPage.controller.VisualFilterDialogController", {
		...
		*/
		...
		_addChartCustomToolbar: function(obj, idx) {
			...
			sPrefixId = this.oState.alr_visualFilterBar.getView().sId,
			sId = sPrefixId + "--" + StableIdHelper.getStableId({type: "VisualFilterDialog", subType: "ValueHelpButton", sProperty: props.parentProperty}),
			count,
			items = [
					new Button({
						type: "Transparent",
