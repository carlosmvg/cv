...
sap.ui.define([
	...
	"sap/ui/core/routing/HashChanger"
			 ...
			 Parameters, Log, Measurement, uid, encodeXML, GraphRenderer, ToggleButton, HashChanger) {
	"use strict";
	...
	Graph.prototype.onAfterRendering = function () {
		...
		//attach to window hash change event
		this.oHashChanger.attachEvent("hashChanged", function() {
			//call toggleFullScreen only when this._bIsFullScreen is true.
			//internally this only closes the already open full screen
