...
sap.ui.define([
    ...
    "sap/ushell/EventHub",
    "sap/base/Log"
], function (coreLibrary, MessageBox, MessageToast, resources, EventHub, Log) {
    "use strict";
    var ActionMode = {};
    ...
    ActionMode.moveSection = function (oEvent, oSource, oParameters) {
        ...
        return oComponent.getPagesService()
            ...
            .then(function () {
                ...
                oComponent.getInvisibleMessageInstance().announce(sSectionMovedMessage, coreLibrary.InvisibleMessageMode.Polite);
            });
    };
