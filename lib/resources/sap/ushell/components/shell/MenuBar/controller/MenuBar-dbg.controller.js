...
sap.ui.define([
    ...
    "sap/m/IconTabFilter",
    "sap/ushell/utils"
], function (Controller, JSONModel, ObjectPath, EventHub, resources, WindowUtils, IconTabFilter, ShellUtils) {
    "use strict";
    ...
    return Controller.extend("sap.ushell.components.shell.MenuBar.controller.MenuBar" /** @lends sap.ushell.components.shell.MenuBar.controller.MenuBar.prototype */, {
        ...
        _selectIndexAfterRouteChange: function () {
            ...
            return Promise.all([
                ...
                if (ShellUtils.isRootIntent(sHash)) {
        ...
        _menuFactory: function (sId, oContext) {
            var oControl = new IconTabFilter({
                key: oContext.getProperty("uid"),
                text: oContext.getProperty("title"),
                enabled: {
                    path: "viewConfiguration>/enableMenuBarNavigation"
                }
            });
            if (oContext.getProperty("menuEntries")) {
