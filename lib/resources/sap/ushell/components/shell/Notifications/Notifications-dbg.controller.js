...
sap.ui.define([
    ...
    sap.ui.controller("sap.ushell.components.shell.Notifications.Notifications", {
        ...
        addBufferToModel: function (sSortingType, oResult) {
            ...
            this.handleListCSSClass(sSortingType, !mergedArrays.length);
        ...
        handleListCSSClass: function (sSortingType, bIsListEmpty) {
            this.getNotificationList(sSortingType).toggleStyleClass("sapContrast", bIsListEmpty);
        },
