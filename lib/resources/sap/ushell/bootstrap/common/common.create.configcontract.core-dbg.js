...
function (URI) {
    ...
    function createConfigContract (oMergedSapUshellConfig) {
        ...
        // enableBackgroundShapes has default value === false in Spaces FLP and default value === true in classic FLP
        ...
        var oConfigDefinition = {
            core: { // the unified shell core
                ...
                spaces: {
                    ...
                    vizInstantiation: {
                        // feature switch for development
                        // will be removed once the vizLoading service is replaced completely
                        // by the visualizationInstantiation service
                        enabled: getConfigValue("ushell/spaces/vizInstantiation/enabled", true)
                    }
                },
                darkMode: {
                ...
                catalog: {
                    enabled: getConfigValue("renderers/fiori2/componentData/config/enablePersonalization",
                        getConfigValue("renderers/fiori2/componentData/config/applications/Shell-home/enablePersonalization", true))
                        || getConfigValue("renderers/fiori2/componentData/config/enableAppFinder", false),
