...
sap.ui.define([
    ...
    function loadPOCPlugins() {
        var urlParams;

        try {
            urlParams = new UriParameters(document.URL);
            if (urlParams.get("sap-wapoc") === "true") {
                jQuery.getScript("https://education3.hana.ondemand.com/education3/pub/cflp_falko/adaptable/web_assistant_init_cflp/init_web_assistant.js", function () {
                    sap.ushell.Container.getRenderer("fiori2").addHeaderEndItem("sap.ushell.ui.shell.ShellHeadItem",
                        {
                            id: "xraybtn",
                            tooltip: "Web Assistance for cFLP - POC",
        ...
        try {
            if (urlParams.get("sap-rtapoc") === "true") {
                sap.ushell.Container.getService("PluginManager").registerPlugins({
                    RTAPOCPlugin: {
                        component: "sap.ushell.appRuntime.ui5.plugins.rtaShell",
                        url: jQuery.sap.getResourcePath("sap/ushell/appRuntime/ui5/plugins/rtaShell"),
                        config: {
