...
(function (global) {
    ...
    sap.ui.define([
        ...
        'sap/ushell/renderers/fiori2/search/cFLPUtil'
        ...
        /*NavigationTarget,*/
        EventLogger, SearchUrlParser, cFLPUtil /*, SearchShellHelper*/ ) {
        ...
        var SearchModel = sap.ui.model.json.JSONModel.extend("sap.ushell.renderers.fiori2.search.SearchModel", {
            ...
            createSina: function () {
                ...
                sap.ui.require(['sap/ushell/renderers/fiori2/search/sinaNext/sina/sinaFactory'], function (sinaFactory) {
                    ...
                    // cFlp
                    cFLPUtil.readCFlpConfiguration(trial).then(function (trial) {
            ...
            enableOrDisableMultiSelection: function () {
                ...
                if (this.isSearchInputHelp || this.isSearchInputHelpWizard) {
            ...
            updateSearchURLSilently: function (deserialization) {
                if (deserialization || this.preventUpdateURL || this.isSearchInputHelp) {
                    // (1) url changed
