    ...
    sap.m.Input.extend('sap.ushell.renderers.fiori2.search.controls.SearchInput', {
        ...
        handleSuggestionItemSelected: function (oEvent) {
            ...
            case SuggestionType.Object:
                // object
                if (oModel.isSearchInputHelp) {
                    this.setValue(suggestion.label);
                } else if (suggestion.titleNavigation) {
        ...
        navigateToSearchApp: function () {
            ...
            if (SearchHelper.isSearchAppActive() || this.getModel().preventUpdateURL || this.getModel().isSearchInputHelp) {
