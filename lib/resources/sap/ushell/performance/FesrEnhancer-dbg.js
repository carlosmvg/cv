...
sap.ui.define([
...
], function (FrontendSubRecords, fnClone, Ui5Log, ShellAnalytics) {
    "use strict";
    ...
    var oFesrEnhancer = {
        ...
        _enhanceInitialStart: function (oIntermediateResult, sStepName, sPerformanceMarkName) {
            var oMark,
                oEnhancedFesrHandle = fnClone(oIntermediateResult);
        ...
        _enhanceNavigationRecord: function (oIntermediateResult, oRelatedRecord) {
            var oEnhancedFesrHandle = fnClone(oIntermediateResult);
