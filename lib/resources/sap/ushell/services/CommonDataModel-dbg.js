...
sap.ui.define([
    ...
    /**
     * Gets the personalization, applies it on the page and stores it
     ...
     * @private
     */
    CommonDataModel.prototype._loadAndApplyPagePersonalization = function (oPage) {
        var sPageId = oPage.identification.id;

        var oPersonalizationPromise = new Promise(function (resolvePers, rejectPers) {
    ...
    CommonDataModel.prototype.getPage = function (sPageId) {
        return new Promise(function (resolve, reject) {
            ...
            this._oGetSitePromise
                .done(function () {
                    this._getPageFromAdapter(sPageId)
                        .then(function (oPage) {
                            if (bEnablePersonalization) {
                                this._loadAndApplyPagePersonalization(oPage)
                                    .then(resolve)
                                    .catch(function () {
    ...
    CommonDataModel.prototype._getPageFromAdapter = function (sPageId) {
        if (!this._oAdapter.getPage) {
            return Promise.resolve(this._oOriginalSite.pages[sPageId]);
        }
                ...
                .done(function () {
                    this._getPagesFromAdapter(aPageIds)
                        .then(function (oPages) {
                            var oPersonalizationPromise = Promise.resolve(objectValues(oPages));

                            if (bEnablePersonalization) {
                                oPersonalizationPromise = Promise.all(Object.keys(oPages).map(function (sPageId) {
                                    return this._loadAndApplyPagePersonalization(oPages[sPageId])
                                        .catch(function () {
                                            reject("Personalization Processor: Cannot mixin the personalization.");
                                        });
                                }.bind(this)));
                            ...
                            oPersonalizationPromise.then(function (aPages) {
                                var aFilteredPages = aPages.filter(function (oPage) {
                                    return !!oPage;
                                });
                                resolve(aFilteredPages);
                            });
                        }.bind(this))
                        .catch(function () {
    ...
    CommonDataModel.prototype._getPagesFromAdapter = function (aPageIds) {
        if (!this._oAdapter.getPages) {
            ...
            return Promise.resolve(oPagesToReturn);
        }
    ...
    CommonDataModel.prototype.getOriginalPage = function (pageId) {
        return this._oOriginalSite.pages[pageId];
    };
    ...
    CommonDataModel.prototype.save = function (pageId) {
        ...
        this._oPersonalizationProcessor.extractPersonalization(oPersonalizedPage, oOriginalPage)
            ...
            this._oPendingPersonalizationDeferred
                ...
                .always(function () {
                    ...
                    if (this._oNextPersonalizationQuery) {
                        ...
                        this._cleanupPersonalizationQueuePromises(oNextPersonalizationPromise, this._oNextPersonalizationQuery.aPromiseResolvers);
