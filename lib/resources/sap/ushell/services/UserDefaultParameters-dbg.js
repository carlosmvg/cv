    ...
    function UserDefaultParameters (oAdapter, oContainerInterface, sParameter, oConfig) {
        ...
        */
        ...
        this._iterateOverPluginsToGetDefaultValue = function (sParameterName, oStartValue, oSystemContext) {
            ...
            var oPluginManagerService = sap.ushell.Container.getService("PluginManager");
        ...
        this._getUserDefaultParameterNames = function (systemContext) {
            if (!this._oUserDefaultParametersNames[systemContext.id]) {
                this._oUserDefaultParametersNames[systemContext.id] = new jQuery.Deferred();

                sap.ushell.Container.getService("ClientSideTargetResolution").getUserDefaultParameterNames(systemContext)
                    .done(function (oParametersAndExtendedParameters) {
                        var oExtractedArrays = this._extractKeyArrays(oParametersAndExtendedParameters);
                        ...
                        this._oUserDefaultParametersNames[systemContext.id].resolve({
            ...
            return this._oUserDefaultParametersNames[systemContext.id].promise();
        };
        ...
        this.getValue = function (sParameterName, oSystemContext) {
            ...
            this._isRelevantParameter(sParameterName, oSystemContext)
                ...
                .then(function (oPersistedValue) {
                    ...
                    this._iterateOverPluginsToGetDefaultValue(sParameterName, oPersistedValue, oSystemContext)
            ...
            this._getUserDefaultParameterNames(oSystemContext)
                .done(function (oParametersAndExtendedParameters) {
                   if (oParametersAndExtendedParameters.oMetadataObject.length === 0) {
                       ...
                       sap.ushell.Container.getService("PluginManager").loadPlugins("UserDefaults")
                           .done(function () {
