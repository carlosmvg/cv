...
sap.ui.define([
    ...
    AppState.prototype._getGeneratedKey = function (transient) {
        var sKey = sap.ushell.Container.getService("Personalization").getGeneratedKey();
        if (transient) {
    ...
    AppState.prototype.createEmptyAppState = function (oComponent, bTransient, iPersistencyMethod, oPersistencySettings) {
        var sKey = this._getGeneratedKey(bTransient),
            oAppState,
            sAppName = "",
            sACHComponent = "",
     ...
     * @private
     */
    AppState.prototype.setAppStateToPublic = function (sURL) {
        ...
        if (sXStateKey !== undefined) {
            this.makeStatePersistent(sXStateKey, AppStatePersistencyMethod.PublicState);
        }
        if (sIStateKey !== undefined) {
            this.makeStatePersistent(sIStateKey, AppStatePersistencyMethod.PublicState);
        }
    };
     ...
     * @returns sValue {String} The requested param data
     */
