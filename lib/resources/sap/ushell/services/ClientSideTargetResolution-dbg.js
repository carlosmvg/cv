...
sap.ui.define([
    ...
    ClientSideTargetResolution.prototype._getMatchingInbounds = function (oShellHash, oInboundIndex, oConstraints) {
        ...
        // initial match
        oSearch
            .match(oShellHash, aPreFilteredInbounds, {} /* known default */, fnGetContentProviderLookup, oCSTRUtils.isDebugEnabled())
            ...
            .then(function (oInitialMatchWithReferencesResult) {
                ...
                return oSearch.match(oShellHash, aMatchingInbounds, oReferences, fnGetContentProviderLookup, 0 /* iDebugLevel */).then(function (oFinalMatchResult) {
                    oLogger.log(function () {
     ...
     * The systemContext for which the user default parameter names should be returned
     *
     * @returns {jQuery.Deferred.promise}
    ...
    ClientSideTargetResolution.prototype.getUserDefaultParameterNames = function (oSystemContext) {
        ...
        this._oInboundProvider.getInbounds().then(
            function (oInboundIndex) {
                var oRes;
                try {
                    oRes = that._getUserDefaultParameterNames(oInboundIndex.getAllInbounds(), oSystemContext);
     ...
     * @returns {Promise<SystemContext>} A Promise that resolves to the systemContext of the given systemId.
     *
     * @private
     * @since 1.78.0
     */
        ...
        return new Promise(function (resolve, reject) {
            ...
            this._oAdapter.resolveSystemAlias(sSystemId)
                .done(function (oSystemAlias) {
                    oSystemContext = SystemContext.createSystemContextFromSystemAlias(oSystemAlias);
