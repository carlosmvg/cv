...
sap.ui.define([
    ...
    sap.ui.jsview("sap.ushell.ui.footerbar.SaveAsTile", {
        ...
        createContent: function (oController) {
            ...
            // Note: In spaces mode, the list contains spaces but not groups
            var sTargetsLabelText = Config.last("/core/spaces/enabled") ? this.oResourceBundle.getText("SpaceListItem_label") : this.oResourceBundle.getText("GroupListItem_label");
