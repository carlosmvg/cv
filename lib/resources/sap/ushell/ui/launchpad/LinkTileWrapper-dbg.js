...
sap.ui.define([
     ...
     * @private
     */
    LinkTileWrapper.prototype.onclick = function (oEvent) { this._onPress(oEvent); };
    LinkTileWrapper.prototype.onsapenter = function (oEvent) { this._launchTileViaKeyboard(oEvent); };
    LinkTileWrapper.prototype.onsapspace = function (oEvent) { this._launchTileViaKeyboard(oEvent); };
