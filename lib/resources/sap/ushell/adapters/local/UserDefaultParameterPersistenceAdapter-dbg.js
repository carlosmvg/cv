...
sap.ui.define([
    ...
    UserDefaultParameterPersistenceAdapter.prototype._getUDContainer = function (oSystemContext) {
        ...
        if (!this._oContainerPromises[oSystemContext.id]) {
            ...
            this._oContainerPromises[oSystemContext.id] = oPersonalizationService.getContainer("sap.ushell.UserDefaultParameter" + sSystemId, { keyCategory: oPersonalizationService.constants.keyCategory.FIXED_KEY, writeFrequency: oPersonalizationService.constants.writeFrequency.LOW, clientStorageAllowed: true });
        }
